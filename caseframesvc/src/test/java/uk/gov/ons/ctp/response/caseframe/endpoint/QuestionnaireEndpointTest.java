 ...
 */
public class QuestionnaireEndpointTest extends CTPJerseyTest {
  ...
  public void findQuestionnaireByIacNotFound() {
    with("http://localhost:9998/questionnaires/iac/%s", QUESTIONNAIRE_IAC_NOT_FOUND)
            ...
            .assertStringInBody("$.error.message", String.format("Cannot find Questionnaire for iac %s", QUESTIONNAIRE_IAC_NOT_FOUND))
            .andClose();
  }
  ...
  public void findQuestionnaireByCaseid() {
    with("http://localhost:9998/questionnaires/case/%d", QUESTIONNAIRE_CASEID)
            ...
            .assertStringListInBody("$..dispatchDateTime", QuestionnaireBuilder.QUESTIONNAIRE_DISPATCHDATE_VALUE, QuestionnaireBuilder.QUESTIONNAIRE_DISPATCHDATE_VALUE)
            .assertStringListInBody("$..responseDateTime", QuestionnaireBuilder.QUESTIONNAIRE_RESPONSEDATE_VALUE, QuestionnaireBuilder.QUESTIONNAIRE_RESPONSEDATE_VALUE)
            .assertStringListInBody("$..receiptDateTime", QuestionnaireBuilder.QUESTIONNAIRE_RECEIPTDATE_VALUE, QuestionnaireBuilder.QUESTIONNAIRE_RECEIPTDATE_VALUE)
            .andClose();
  }
