...
public interface TransformationService {
  ...
  /**
   * This produces a stream for all action requests not already sent applying
   * the template mapped in the stored mapping document.
   *
   * @return SftpMessage with stream objects and list of ActionRequest Ids.
   */
  SftpMessage applyTemplatesStreamMe();
}
