 ...
 * that these tests
 * require the mocked category data to represent the real Category table data in
 * order to be
 * effective.
 */
...
public class CaseServiceTest {
    ...
    public void testCaseGroupStatusIsTransitioned() throws Exception {
        ...
        CaseEvent caseEvent1 = fabricateEvent(
     ...
     * ACTIONABLE BRES case
     * (the one created for a respondent BI, accountant replying on behalf of Tesco
     * for instance)
     *
     * @throws Exception if fabricateEvent does
     */
    ...
    public void testEventActionCancellationCompleted() throws Exception {
        ...
        CaseEvent caseEvent = fabricateEvent(
     ...
     * maxCasesPerSurvey and
     * that the later cases in the list are rejected This suffices because
     * SpringBoot implements the
     ...
     * ACTIONABLE BRES case (the
     * one created for a respondent BI, accountant replying on behalf of Tesco for
     * instance)
     *
     * @throws Exception if fabricateEvent does
     */
     ...
     * INACTIONABLE, and all
     * associated BI cases in the case group. The action service is notified of the
     * transition of all
