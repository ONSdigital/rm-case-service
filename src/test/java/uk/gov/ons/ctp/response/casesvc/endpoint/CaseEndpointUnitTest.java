...
public final class CaseEndpointUnitTest {
    ...
    private static final UUID CASE_ID_UNCHECKED_EXCEPTION_CASE = UUID
            .fromString("7bc5d41b-0549-40b3-ba76-42f6d4cf3999");
    private static final UUID EXISTING_SURVEY_ID = UUID.fromString("cb8accda-6118-4d3b-85a3-149e28960c54");
    ...
    private static final UUID CASE1_CASEGROUP_COLLECTION_EXERCISE_ID = UUID
            .fromString("dab9db7f-3aa0-4866-be20-54d72ee185fb");
    ...
    private static final String CASEEVENT_INVALIDJSON = "{\"description\":\"a\",\"category\":\"BAD_CAT\",\"createdBy\":\"u\"}";
    private static final String CASEEVENT_VALIDJSON = "{\"description\":\"sometest\",\"category\":\"RESPONDENT_ENROLED\",\"createdBy\":\"unittest\", "
            + "\"metadata\":{\"partyId\":\"3b136c4b-7a14-4904-9e01-13364dd7b972\"}}";
    private static final String CASEEVENT_VALIDJSON_NO_NEW_CASE = "{\"description\":\"sometest\",\"category\":\"EQ_LAUNCH\",\"createdBy\":\"unittest\"}";
    ...
    public void setUp() throws Exception {
        ...
        this.mockMvc = MockMvcBuilders.standaloneSetup(caseEndpoint)
    ...
    public void findCaseByCaseIdFoundWithCaseEventsAndIac() throws Exception {
        ...
        actions.andExpect(
                jsonPath("$.caseGroup.collectionExerciseId", is(CASE1_CASEGROUP_COLLECTION_EXERCISE_ID.toString())));
        ...
        actions.andExpect(jsonPath("$.caseEvents[*].createdDateTime",
                contains(new DateMatcher(CASE_DATE_VALUE_1), new DateMatcher(CASE_DATE_VALUE_2),
                        new DateMatcher(CASE_DATE_VALUE_3), new DateMatcher(CASE_DATE_VALUE_1))));
    }
    ...
    public void findCasesByPartyIdFoundWithoutCaseEventsAndIac() throws Exception {
        ...
        actions.andExpect(jsonPath("$[*].id",
                containsInAnyOrder(CASE1_ID.toString(), CASE2_ID.toString(), CASE3_ID.toString(), CASE4_ID.toString(),
                        CASE5_ID.toString(), CASE6_ID.toString(), CASE7_ID.toString(), CASE8_ID.toString(),
                        CASE9_ID.toString())));
        actions.andExpect(
                jsonPath("$[*].caseRef", containsInAnyOrder(ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE)));
        ...
        actions.andExpect(jsonPath("$[*].caseGroup.id",
                containsInAnyOrder(CASE1_CASEGROUP_ID.toString(), CASE1_CASEGROUP_ID.toString(),
    ...
    public void findCasesByPartyIdFoundWithCaseEventsAndIac() throws Exception {
        ...
        ResultActions actions = mockMvc
                .perform(getJson(String.format("/cases/partyid/%s?caseevents=true&iac=true", EXISTING_PARTY_UUID)));
        ...
        actions.andExpect(
                jsonPath("$[*].caseRef", containsInAnyOrder(ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE)));
        actions.andExpect(jsonPath("$[*].iac", containsInAnyOrder(IAC_CASE1, IAC_CASE2, IAC_CASE3, IAC_CASE4, IAC_CASE5,
                IAC_CASE6, IAC_CASE7, IAC_CASE8, IAC_CASE9)));
    ...
    public void findCaseBySurveyId() throws Exception {
        ...
        ResultActions actions = mockMvc.perform(getJson(String.format("/cases/surveyid/%s", EXISTING_SURVEY_ID)));
    ...
    public void findCaseByIACNotFound() throws Exception {
        ...
        actions.andExpect(jsonPath("$.error.code", is(CTPException.Fault.RESOURCE_NOT_FOUND.name())));
        actions.andExpect(
                jsonPath("$.error.message", is(String.format("%s iac %s", ERRORMSG_CASENOTFOUND, NON_EXISTING_IAC))));
        actions.andExpect(jsonPath("$.error.timestamp", isA(String.class)));
    }
    ...
    public void findCasesByCaseGroupIdNotFound() throws Exception {
        ResultActions actions = mockMvc
                .perform(getJson(String.format("/cases/casegroupid/%s", NON_EXISTING_CASE_GROUP_UUID)));
        ...
        actions.andExpect(jsonPath("$.error.code", is(CTPException.Fault.RESOURCE_NOT_FOUND.name())));
        actions.andExpect(jsonPath("$.error.message",
                is(String.format("CaseGroup not found for casegroup id %s", NON_EXISTING_CASE_GROUP_UUID))));
        actions.andExpect(jsonPath("$.error.timestamp", isA(String.class)));
    }
    ...
    public void findCasesByCaseGroup() throws Exception {
        ...
        ResultActions actions = mockMvc
                .perform(getJson(String.format("/cases/casegroupid/%s", EXISTING_CASE_GROUP_UUID)));
    ...
    public void findCaseEventsByCaseIdFound() throws Exception {
        ...
        actions.andExpect(jsonPath("$[*].description",
                containsInAnyOrder(CASE1_DESCRIPTION, CASE2_DESCRIPTION, CASE3_DESCRIPTION, CASE9_DESCRIPTION)));
        actions.andExpect(jsonPath("$[*].category",
                containsInAnyOrder(CASE1_CATEGORY, CASE2_CATEGORY, CASE3_CATEGORY, CASE9_CATEGORY)));
        actions.andExpect(jsonPath("$[*].subCategory",
                containsInAnyOrder(CASE1_SUBCATEGORY, CASE2_SUBCATEGORY, CASE3_SUBCATEGORY, null)));
        actions.andExpect(jsonPath("$[*].createdBy",
                containsInAnyOrder(CASE1_CREATEDBY, CASE2_CREATEDBY, CASE3_CREATEDBY, CASE9_CREATEDBY)));
        actions.andExpect(jsonPath("$[*].createdDateTime",
                contains(new DateMatcher(CASE_DATE_VALUE_1), new DateMatcher(CASE_DATE_VALUE_2),
                        new DateMatcher(CASE_DATE_VALUE_3), new DateMatcher(CASE_DATE_VALUE_1))));
    ...
    public void findCaseEventsByCaseIdAndCategoryFoundButNoEvents() throws Exception {
        ...
        ResultActions actions = mockMvc.perform(getJson(
                String.format("/cases/%s/events?category=SUCCESSFUL_RESPONSE_UPLOAD", EXISTING_CASE_ID_NO_EVENTS)));
    ...
    public void findCaseEventsByCaseIdAndCategoryFound() throws Exception {
        ...
        ResultActions actions = mockMvc
                .perform(getJson(String.format("/cases/%s/events?category=SUCCESSFUL_RESPONSE_UPLOAD", CASE1_ID)));
    ...
    public void createCaseEventBadJson() throws Exception {
        ResultActions actions = mockMvc
                .perform(postJson(String.format("/cases/%s/events", CASE9_ID), CASEEVENT_INVALIDJSON));
    ...
    public void createCaseEventCaseNotFound() throws Exception {
        ResultActions actions = mockMvc
                .perform(postJson(String.format("/cases/%s/events", NON_EXISTING_CASE_ID), CASEEVENT_VALIDJSON));
    ...
    public void createCaseEventGoodJson() throws Exception {
        ...
        ResultActions actions = mockMvc
                .perform(postJson(String.format("/cases/%s/events", CASE9_ID), CASEEVENT_VALIDJSON));
    ...
    public void createCaseEventWithMetadata() throws Exception {
        ...
        assertEquals(CASE_EVENT_PARTY_UUID, caseEventArgumentCaptor.getValue().getMetadata().get("partyId"));
    }
    ...
    public void createCaseEventNoNewCase() throws Exception {
        ...
        ResultActions actions = mockMvc
                .perform(postJson(String.format("/cases/%s/events", CASE9_ID), CASEEVENT_VALIDJSON_NO_NEW_CASE));
    ...
    public void createCaseEventGoodJsonButVersusIncorrectSampleUnitType() throws Exception {
        ...
        actions.andExpect(status().isBadRequest()).andExpect(handler().handlerType(CaseEndpoint.class))
