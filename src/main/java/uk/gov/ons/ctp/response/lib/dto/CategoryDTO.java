...
public class CategoryDTO {
  ...
  public enum CategoryName {
    ...
    CASE_CREATED, GENERATE_ENROLMENT_CODE, ACCESS_CODE_AUTHENTICATION_ATTEMPT, ONLINE_QUESTIONNAIRE_RESPONSE,
    RESPONDENT_ENROLED, DISABLE_RESPONDENT_ENROLMENT, RESPONDENT_ACCOUNT_CREATED, COLLECTION_INSTRUMENT_DOWNLOADED,
    EQ_LAUNCH, UNSUCCESSFUL_RESPONSE_UPLOAD, SUCCESSFUL_RESPONSE_UPLOAD, OFFLINE_RESPONSE_PROCESSED,
    SECURE_MESSAGE_SENT, VERIFICATION_CODE_SENT, COLLECTION_INSTRUMENT_ERROR, COMPLETED_BY_PHONE, NO_LONGER_REQUIRED,
    NO_ACTIVE_ENROLMENTS, PRIVACY_DATA_CONFIDENTIALITY_CONCERNS, PHYSICALLY_OR_MENTALLY_UNABLE,
    LACK_OF_COMPUTER_INTERNET_ACCESS, TOO_BUSY, COMPLY_IN_DIFFERENT_COLLECTION_MODE, NON_RESIDENTIAL_ADDRESS,
