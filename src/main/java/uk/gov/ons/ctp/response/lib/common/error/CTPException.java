...
public class CTPException extends Exception {
  ...
  public static class OurExceptionSerializer
      extends JsonSerializer<uk.gov.ons.ctp.response.lib.common.error.CTPException> {
    /**
     * To customise the serialization of CTPException objects
     *
    ...
    public final void serialize(
        final uk.gov.ons.ctp.response.lib.common.error.CTPException value,
