...
ALTER TABLE casesvc.address RENAME lad12cd  TO lad;
ALTER TABLE casesvc.address RENAME region11cd  TO region;
ALTER TABLE casesvc.address ADD column htc numeric(8,0);
ALTER TABLE casesvc.address ADD column temp_sample character varying(20);
