...
INSERT INTO category (name, longdescription, eventtype, manual, role, generatedactiontype, "group", shortdescription, newcaserespondenttype, oldcaserespondenttype) VALUES ('REFUSAL', 'Refusal', 'DEACTIVATED', true, 'collect-csos, collect-field-escalate, collect-general-escalate, collect-admins', NULL, 'general', 'Refusal', NULL, NULL);
