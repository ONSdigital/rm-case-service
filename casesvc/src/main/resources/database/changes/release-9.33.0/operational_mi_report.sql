...
BEGIN
    ...
    FOR v_loop in 2 ..8 LOOP
       ...
       INSERT INTO casesvc.report(reporttype, contents, createddatetime) VALUES(v_viewname[v_loop], v_contents, CURRENT_TIMESTAMP); 
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION casesvc.generate_operational_mi_reports()
  OWNER TO casesvc;
