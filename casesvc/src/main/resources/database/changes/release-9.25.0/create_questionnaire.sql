-- Function: casesvc.create_questionnaire(bigint, character varying)

-- DROP FUNCTION casesvc.create_questionnaire(bigint, character varying);

CREATE OR REPLACE FUNCTION casesvc.create_questionnaire(p_caseid bigint, p_questionset character varying)
  RETURNS boolean AS
$BODY$
DECLARE
